<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="box box-primary">
            ...
            <form action="<?= base_url('Gallery/addGalleryAlbumPost'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" onclick="deleteItem('Gallery/deleteGalleryAlbumPost','<?= $item->id; ?>','<?= trans("confirm_album"); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
