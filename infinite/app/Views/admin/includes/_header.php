...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/plugins/file-manager-4.4/file-manager.css'); ?>">
    <link rel="stylesheet" href="<?= base_url('assets/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css'); ?>">
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/custom-4.4.min.css'); ?>">
