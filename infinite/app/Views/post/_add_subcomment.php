<?php if (authCheck()): ?>
	<div class="sub-comment-form-registered">
		<div class="row">
			<div class="col-sm-12">
				<form id="form_add_subcomment_registered_<?= $parentComment->post_id; ?>">
					...
					<button type="button" class="btn btn-sm btn-custom btn-subcomment-registered" data-comment-id="<?= $parentComment->post_id; ?>" aria-label="add comment"><?= trans("post_comment"); ?></button>
				</form>
		...
		<div class="row">
			<div class="col-sm-12">
				<form id="form_add_subcomment_<?= $parentComment->post_id; ?>">
					...
					<input type="hidden" name="parent_id" value="<?= $parentComment->id; ?>">
					<input type="hidden" name="post_id" value="<?= $parentComment->post_id; ?>">
					<button type="button" class="btn btn-sm btn-custom btn-subcomment" data-comment-id="<?= $parentComment->post_id; ?>" aria-label="add comment"><?= trans("post_comment"); ?></button>
				</form>
				<div id="message-subcomment-result-<?= $parentComment->post_id; ?>"></div>
			</div>
		</div>
