...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        mysqli_query($connection, "INSERT INTO users (username, slug, email, password, token, role_id, status, user_type) VALUES
 ('" . $admin_username . "', '" . $slug . "', '" . $admin_email . "','" . $password . "','" . $token . "', 1, 1, 'registered')");
